"""
Django settings for organigrama project.
...
SECRET_KEY = 'm#qfa35z($4jcs-f037p5%=iesxv3kbbl*)^esk)m72nuj6y)@'
...
WSGI_APPLICATION = 'organigrama.wsgi.application'
